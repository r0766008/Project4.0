...
class TruckController extends Controller
{
    ...
    {
        return view('logisticsemployee.trucks.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('logisticsemployee.trucks.index')
    ...
    {
        return view('logisticsemployee.trucks.show', compact('truck'));
    }
    ...
    public function edit(Truck $truck)
    {
        ...
        return view('logisticsemployee.trucks.edit', compact('truck', 'users', 'remainingusers'))
            ->with('i', (request()->input('page', 1) - 1) * 5);
    }
    ...
    public function addDriver($truckId, Request $request) {
        ...
        return redirect()->route('logisticsemployee.trucks.edit', $truck)
