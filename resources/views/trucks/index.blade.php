    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="float-right">
                <a class="btn btn-success" href="{{ route('trucks.create') }}">Create a truck<i class="fas fa-plus-circle"></i></a>
            </div>
            <br><br>
        </div>
    </div>
                ...
                <tr data-href="{{ route('trucks.show', $truck->id) }}" onclick="window.location.href = this.getAttribute('data-href');" style="cursor: pointer;">
                    ...
                    <td>
                        <form action="{{ route('trucks.destroy', $truck->id) }}" method="POST">
                            <a class="btn btn-primary" href="{{ route('trucks.edit', $truck->id) }}"><span class="material-icons">edit</span></a>
